export default {
  ...
  version: {
    creator: {
      customLabel: '定制版',
      versionInfo: '查看当前定制版与官方版本',
      officialLatest: '官方最新正式版',
      officialUnavailable: '暂时无法获取',
      officialCached: '刷新失败，显示上次获取的官方版本。',
      officialUpdateAvailable: '官方已发布更新的正式版，可一键合并并部署。',
      officialHint: '一键更新会合并官方源码，正式版号相同也可能有新提交。',
      buildDetails: '构建详情',
      fullVersion: '完整构建版本',
      mergedOfficialCommit: '当前已合并的官方提交',
      title: '保留自定义功能更新',
      localHint: '本地测试：合并官方代码、测试并构建定制版。当前网站继续运行。',
      deployHint: '保留自定义代码，合并官方更新。测试通过后自动备份、部署并重启；启动失败自动恢复旧程序。涉及数据库迁移时暂停部署。',
      deployStart: '一键更新并部署',
      deployed: '更新部署成功，健康检查已通过。',
      rolledBack: '更新未完成，已自动恢复之前的版本。',
      recoveryRequired: '自动恢复未完成，已暂停后续更新，请检查服务日志。',
      reconnecting: '服务正在切换版本，正在自动重新连接…',
      disabled: '本地更新任务尚未配置，请按本地更新说明启用。',
      start: '一键合并并测试',
      refreshStatus: '刷新任务状态',
      ready: '本地验证通过，定制版已生成，尚未部署。',
      failed: '任务已停止，当前网站和原代码未被替换。',
      stages: {
        snapshot: '正在准备自定义代码副本…',
        fetch: '正在获取官方代码…',
        merge: '正在合并官方更新…',
        install: '正在安装构建依赖…',
        test_frontend: '正在测试前端功能…',
        build_frontend: '正在构建前端…',
        test_backend: '正在测试后端功能…',
        build_backend: '正在构建定制版…',
        backup: '正在备份并验证数据库…',
        deploying: '正在部署并重启服务…',
        health_check: '正在检查新版本运行状态…',
        rolling_back: '正在恢复之前的版本…',
        deployed: '部署完成',
        rolled_back: '已恢复之前版本',
        ready: '本地验证完成'
      }
