export default {
  ...
  version: {
    creator: {
      customLabel: 'Custom',
      versionInfo: 'View custom build and official version',
      officialLatest: 'Latest official release',
      officialUnavailable: 'Currently unavailable',
      officialCached: 'Refresh failed. Showing the previously fetched official version.',
      officialUpdateAvailable: 'A newer official release is available. Merge and deploy with one click.',
      officialHint: 'Updates merge official source code. New commits may exist even when the release version is unchanged.',
      buildDetails: 'Build details',
      fullVersion: 'Full build version',
      mergedOfficialCommit: 'Official commit merged into this build',
      title: 'Update with custom features',
      localHint: 'Local test: merge upstream, test and build your custom version. The current site keeps running.',
      deployHint: 'Preserve custom code and merge upstream updates. After tests pass, back up, deploy and restart automatically. Restore the previous binary if startup fails. Pause deployment if database migrations change.',
      deployStart: 'Update and deploy',
      deployed: 'Update deployed and health check passed.',
      rolledBack: 'Update did not complete. The previous version was restored automatically.',
      recoveryRequired: 'Automatic recovery did not finish. Further updates are paused; check the service logs.',
      reconnecting: 'The service is switching versions. Reconnecting automatically…',
      disabled: 'Local update tasks are not configured. Follow the local update guide to enable them.',
      start: 'Merge and test',
      refreshStatus: 'Refresh task status',
      ready: 'Local validation passed. Your custom build is ready and has not been deployed.',
      failed: 'Task stopped. The current site and original checkout have not been replaced.',
      stages: {
        snapshot: 'Preparing a copy of your custom code…',
        fetch: 'Fetching upstream code…',
        merge: 'Merging upstream updates…',
        install: 'Installing build dependencies…',
        test_frontend: 'Testing frontend features…',
        build_frontend: 'Building frontend…',
        test_backend: 'Testing backend features…',
        build_backend: 'Building your custom version…',
        backup: 'Backing up and verifying the database…',
        deploying: 'Deploying and restarting the service…',
        ...
        ready: 'Local validation complete'
      }
    },
